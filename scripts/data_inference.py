...
class CTReportDatasetinfer(Dataset):
    def __init__(self, data_folder, min_slices=20, resize_dim=500, force_num_frames=True, labels = "labels.csv"):
